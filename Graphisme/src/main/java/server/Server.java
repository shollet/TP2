...
/**
 * Fichier au coeur d'un programme permettant de simuler une inscription d'un etudiant en prenant
 * ses informations et en lui offrant les cours choisis selon la session où il veut s'inscrire de
 * par le terminal et de facon graphique à l'aide de JavaFX
 */
public class Server {
    /**
     * String utilisé dans les procédures suivantes permettant l'inscription de l'etudiant
     */

    public final static String REGISTER_COMMAND = "INSCRIRE";
    /**
     *  String utilisé dans les procédures suivantes permettant d3e charger les cours de la session choisie
     */
     ...
     * @throws IOException permettant de gérer les erreurs de serveur
     */
     ...
     * parts et arg.
     * @throws IOException Exception pour gérer les erreurs du serveur
     * @throws ClassNotFoundException Exception pour gérer la recherche de la classe
     */
    ...
    public void handleLoadCourses(String arg) {
    	String session = arg;
    	String filePath = "src\\server\\data\\cours.txt";
    ...
    public void handleRegistration() {
    	...
    	String filePath = "src\\server\\data\\inscription.txt";
